            ...
            <div className="flex flex-col h-full p-3 w-60 bg-gray-900 text-gray-100">
                <div >
                    ...
                    <div className="relative">
                        ...
                        <input type="search" name="Search" placeholder="Search..." className="w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none bg-gray-800 text-gray-100 " />

                    </div>

                    <div className="max-w-screen-xl mx-auto mt-4 ">
                        <div className="hidden sm:flex flex-col border-l gap-y-3 text-sm">
                            {tabItems.map((item, idx) => (
                                <div
                                    key={idx}
                                    className={`group outline-none px-1.5 border-l-2 border-white ${selectedTab === item ? 'border-indigo-600 text-indigo-600' : 'text-gray-500'
                                        }`}
                        ...
                        {tabItems.map((item, idx) => (
                            <div key={idx} className={`py-6 ${selectedTab === item ? '' : 'hidden'}`}>
